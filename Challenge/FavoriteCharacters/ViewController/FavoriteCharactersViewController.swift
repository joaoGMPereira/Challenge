...
protocol FavoriteCharactersViewControllerInterface: class {
...
class FavoriteCharactersViewController: UIViewController {
    ...
    //MARK: Properties
    var interactor: FavoriteCharactersInteractorInterface?
    var router: FavoriteCharactersRouterInterface?
...
extension FavoriteCharactersViewController: JEWCodeView {
    ...
    func setupConstraints() {
        collectionView.setupConstraints(parent: view, top: 0, bottom: 0, leading: 0, trailing: 0)
    ...
    private func setupErrorInfo() {
        ...
        errorMessageLabel.text = FavoriteCharactersConstants.noFilteredFavorites
        errorMessageLabel.textColor = .JEWBlack()
        errorMessageLabel.font = .JEW32Bold()
        errorMessageLabel.numberOfLines = 0
        errorMessageLabel.textAlignment = .center
        retryButton.setTitle(FavoriteCharactersConstants.goToCharacters, for: .normal)
...
extension FavoriteCharactersViewController: UISearchBarDelegate {
...
extension FavoriteCharactersViewController: ReloadableDelegate {
...
extension FavoriteCharactersViewController: FavoriteCharactersViewControllerInterface {
